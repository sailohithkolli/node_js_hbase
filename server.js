...
app.post('/restaurant/add',function(req,res)
{
	...
	if (food_type.length == 0) errors_arr.push({msg:"Food Type is required."});
	if (phone_number.length == 0) errors_arr.push({msg:"Phone number is required."});
...
app.post('/restaurant/update/', function(req, res){
	...
	if (json_obj.food_type.length == 0) errors_arr.push({msg:"Food Type is required."});
	if (json_obj.phonenumber.length == 0) errors_arr.push({msg:"Phone number is required."});
